...
proto.tradingdb2pb.ReplyUpdCandles.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lengthok: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * @return {string}
 */
proto.tradingdb2pb.ReplyUpdCandles.prototype.getError = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.tradingdb2pb.ReplyUpdCandles.prototype.setError = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional int32 lengthOK = 2;
 * @return {number}
 */
